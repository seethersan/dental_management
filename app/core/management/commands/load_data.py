...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for country_data in data:
            ...
            print(f"Country {country.name} {'created' if created else 'already exists'}")
            ...
            for state_data in country_data['states']:
                ...
                print(f"  State {state.name} {'created' if created else 'already exists'}")
                ...
                for city_data in state_data['cities']:
                    ...
                    print(f"    City {city.name} {'created' if created else 'already exists'}")
